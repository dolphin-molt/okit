...
export const PROVIDER_PRESETS: Record<string, {
  ...
  moonshot: { name: 'Moonshot (Kimi Global)', baseUrl: 'https://api.moonshot.ai/v1', apiKeyVaultKey: 'MOONSHOT_API_KEY', models: ['moonshot-v1-auto', 'moonshot-v1-8k', 'moonshot-v1-32k'] },
  'kimi-coding': { name: 'Kimi', baseUrl: 'https://api.moonshot.cn/v1', apiKeyVaultKey: 'KIMI_API_KEY', models: ['kimi-k2.5', 'kimi-k2-thinking', 'kimi-code'] },
  ...
  'qianfan-coding': { name: '百度千帆 Coding Plan', baseUrl: 'https://qianfan.baidubce.com/v2/tokenplan/personal', apiKeyVaultKey: 'QIANFAN_CODING_PLAN_API_KEY', models: ['qianfan-code-latest', 'kimi-k2.6', 'deepseek-v4-flash', 'glm-5.2'] },
