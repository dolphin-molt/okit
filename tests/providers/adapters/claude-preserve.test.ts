...
vi.mock('../../../src/config/registry', () => ({
  OKIT_DIR: '/tmp/test-okit-claude-preserve',
  REGISTRY_PATH: '/tmp/test-okit-claude-preserve/registry.json',
  LOGS_DIR: '/tmp/test-okit-claude-preserve/logs',
  CACHE_DIR: '/tmp/test-okit-claude-preserve/cache',
}));
