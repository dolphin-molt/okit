...
const AUTO_CREATE_PLATFORMS = [
  ...
  { id: 'anthropic', label: 'Anthropic', keyHint: 'ANTHROPIC_API_KEY', groupHint: 'Anthropic', mode: 'browser', url: 'https://console.anthropic.com/settings/keys', createTexts: ['Create Key', 'Create API Key', 'Create key'], keyPatterns: ['sk-ant-api[a-zA-Z0-9_-]{16,}'] },
